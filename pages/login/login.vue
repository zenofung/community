  ...
  <view class="page">
    ...
    <view class="login-box">
      <view class="login-card-title">
        <view class="login-card-title-content"style="margin-right: 80rpx; " :style="{color:(status == true ? '':'#ff0000')}" @click="updateStatus(0)"> 登录 </view>
		 <view class="login-card-title-content" :style="{color:(status == false ? '':'#ff0000')}" @click="updateStatus(1)"> 注册 </view>
      </view>
